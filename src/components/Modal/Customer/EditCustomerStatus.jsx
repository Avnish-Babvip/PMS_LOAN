...
import { editCustomerStatus } from "../../../features/actions/customer";
import { Spinner } from "../../Loader/Spinner";

export const EditCustomerStatusModal = ({ isOpen, onClose, user }) => {
  ...
  const onSubmit = (data) => {
    dispatch(editCustomerStatus({ payload: data, id: user?.id }))
      .unwrap()
      .then(() => {
        onClose();
      });
