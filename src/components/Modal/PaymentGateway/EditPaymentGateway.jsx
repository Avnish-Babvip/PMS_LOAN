...
import { updatePaymentGateway } from "../../../features/actions/paymentGateway";

export const EditPaymentGatewayModal = ({
  isOpen,
  onClose,
  paymentGateway,
}) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      payment_page_client_id: paymentGateway?.payment_page_client_id,
      response_key: paymentGateway?.response_key,
