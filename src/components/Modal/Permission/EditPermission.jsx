...
import { editPermission } from "../../../features/actions/permission";
import { Spinner } from "../../Loader/Spinner";

export const EditPermissionModal = ({ isOpen, onClose, permission }) => {
  ...
  const onSubmit = (data) => {
    dispatch(editPermission({ payload: data, id: permission?.id }))
      .unwrap()
      .then(() => {
        onClose();
      });
