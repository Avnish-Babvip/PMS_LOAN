...
import { getAllContacts } from "../../features/actions/customer";
...
const Contact = () => {
  ...
  const { contactData, customerLoading } = useSelector(
    ...
    <>
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="font-semibold text-gray-800">All Contacts</h2>
        </div>
        ...
        {/* PAGINATION */}
        {!customerLoading && hasData && contactData && (
          <Pagination
            data={contactData}
            page={page}
            label="customers"
