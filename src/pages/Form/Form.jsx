...
const Form = () => {
  ...
  const { formData, formLoading } = useSelector(
    (state) => state.form,
  );
  ...
  const updateParams = ({ page, search, status, loan_type }) => {
    ...
    if (loan_type !== undefined && loan_type !== "") params.loan_type = loan_type;
        ...
        <div className="relative overflow-x-auto">
          <table className="min-w-[900px] w-full text-sm table-fixed">
            <thead className="bg-gray-50 text-gray-500">
              <tr>
                <th className="text-left ps-5 px-3 py-3 w-[150px]">Form Name</th>
                <th className="text-left px-3 py-3 w-[100px]">Loan Type</th>
                <th className="text-left px-3 py-3 w-[80px]">Status</th>
                <th className="text-left px-3 py-3 w-[80px]">Uploaded File Name</th>
